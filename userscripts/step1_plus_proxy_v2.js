...
(function() {
    ...
    var ranTitle = `HYPER ELITE SOCKS 5 | NUCLEAR SPEED
GOD TIER PROXIES | SOCKS 5 SUPREMACY
ABSOLUTE ELITE SOCKS 5 | ZERO LAG
TITANIUM SOCKS 5 | UNBREAKABLE SPEED
LEGENDARY UHQ PROXIES | SOCKS 5 DOMINANCE
CRACKING BEAST SOCKS 5 | MAX SUCCESS
COMBO KING SOCKS 5 | ELITE PROXIES
CHECKER OPTIMIZED SOCKS 5 | UHQ
CONFIG READY SOCKS 5 | ELITE TIER
TOOL FRIENDLY SOCKS 5 | MAXIMUM POWER
UNDETECTABLE SOCKS 5 | GHOST TIER
UNBANNABLE SOCKS 5 | ELITE QUALITY
BULLETPROOF SOCKS 5 | MAX SECURITY
DOMINATION SOCKS 5 | ELITE PROXIES
SUPREME SOCKS 5 | NO COMPETITION
`;
